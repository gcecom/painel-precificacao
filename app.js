...
// Custo usado no cálculo: 1) custo específico salvo NA PRECIFICAÇÃO (por canal)
...
if($('catalogCategory'))$('catalogCategory').onchange=renderCatalog;
